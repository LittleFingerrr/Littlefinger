...
pub trait IDisbursement<T> {
    ...
    fn pause_disbursement_schedule(ref self: T, schedule_id: u64, member_id: u256);
    fn resume_schedule(ref self: T, schedule_id: u64, member_id: u256);
    fn delete_schedule(ref self: T, schedule_id: u64, member_id: u256);
    ...
    fn set_current_schedule(ref self: T, schedule_id: u64, member_id: u256);
    ...
    fn update_schedule_interval(ref self: T, schedule_id: u64, new_interval: u64, member_id: u256);
    fn update_schedule_type(ref self: T, schedule_id: u64, schedule_type: ScheduleType, member_id: u256);
